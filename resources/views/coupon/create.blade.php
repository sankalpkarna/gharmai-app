						...
						<form class="user" action="{{route('coupon.store')}}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
					            	...
					            	<input type="datetime-local" class="form-control" name="expire_date" id="InputExpireDate" value="{{old(strtotime('expire_date'))}}">
							...
							<div align="center">
							<button type="submit" class="btn btn-primary btn-lg btn-icon-split"><span class="text">Create Coupon</span></button>
							</div>	
						</form>
						<hr>
